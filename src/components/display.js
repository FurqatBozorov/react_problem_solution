...
import { addAnswer,
         ...
         displayResult,
         restart} from '../redux/actions/quetionsAction'
...
const mapStateToProps = (state) => {
    return {
        ...
        activeQuestion: state.questions.activeQuestionIndex,
        resultToDisplay: state.questions.resultToDisplay
    }
}
